...
cc.Class({
    ...
    properties: {
        //---简单声明
        //1---当声明的属性为基本JavaScript类型时，可以直接赋予默认值
        height: 20, //typeof number
        type: 'str', //typeof string
        target: null, //typeof object
        loaded: false, //typeof boolean
        //2---当声明的属性具备类型时（如：cc.Ndoe，cc.Vec2等），可以在声明处填写他们的构造函数来完成声明
        pos: cc.Vec2,
        //3---当声明的属性继承自cc.ValueType时，（如cc.Vec2, cc.Color, cc.Rect）;可以使用构造函数，也可以直接使用实例作为默认值
        color: new cc.Color(255, 255, 255, 128),
        //4---当声明属性是一个数组时，可以在声明处填写他们的类型或构造函数来完成声明
        //4.1---使用类型
        any: [], //不定义具体类型的数组
        bools: [cc.Boolean],
        strings: [cc.String],
