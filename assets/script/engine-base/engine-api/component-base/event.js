cc.Class({
    ...
    onLoad() {
        ...
        //1.1---node.on(type, cb, target)--注册监听事件
        ...
        //1.2---node.once()---在监听函数响应后就会关闭监听事件

        //2---发射事件
        //2.1---node.emit(type, data)---不可以做事件传递
