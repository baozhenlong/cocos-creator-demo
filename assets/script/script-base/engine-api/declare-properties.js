cc.Class({
    ...
    //声明属性    
    properties: {
        //简单声明---当声明的属性为基本JavaScript类型时，可以直接赋予默认值
        height: 20, //typeof number
        type: 'str', //typeof string
        target: null, //typeof object
        loaded: false, //typeof boolean
        //完整声明---当声明的属性具备类型时（如：cc.Ndoe，cc.Vec2等），可以在声明处填写他们的构造函数来完成声明
        pos: cc.Vec2,
